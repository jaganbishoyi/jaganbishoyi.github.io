...
export class ProjectDetailsComponent implements OnInit {
    ...
    constructor(
        ...
        this.activatedRoute.params.subscribe((params: Params) => {
            this.project = projects.find((project: IProject) => project.id == params["projectId"]);
    ...
    ngOnInit(): void {
        ...
        const SEOData: ISeoEssentials = {
            ...
            description:
                this.project?.description.slice(0, -1).join(", ") +
                this.project?.description.slice(-1),
            canonicalLink: `https://jaganbishoyi.github.io/projects/${this.project?.id}/${slug}`,
            image: `https://jaganbishoyi.github.io/assets/images/projects/${this.project?.image}`,
        };
